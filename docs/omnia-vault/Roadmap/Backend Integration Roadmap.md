...
| 5B | Activity + sleep logging (meals later) | Log activity and sleep from Track; save, then reload the dashboard. Next in this sprint. | [[Activity API]], [[Sleep API]], [[Nutrition API]] | `TrackRepository` | Design the logging screens |
