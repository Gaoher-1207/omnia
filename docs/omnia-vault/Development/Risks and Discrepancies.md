...
| D7 | Test count | Re-run: 106 passing at the auth checkpoint; 128 after Phase 3. The README still says 106 (a checkpoint). | Update at the next documentation checkpoint |
